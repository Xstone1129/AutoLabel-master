...
class Annotator:
    ...
    def _init_parser(self):
        ...
        parser.add_argument("--input", "-i", type=str,
                            ...
                            default="/home/xu/2024国赛视频/2024国赛/步兵")
        ...
        parser.add_argument("--skip_frames", "-s", type=int,
                            help="Number of frames to skip between processing",
                            default=0)
        parser.add_argument("--min_confidence", "-c", type=float,
                            help="Minimum detection confidence threshold",
                            default=0.2)
        parser.add_argument("--skip_blank_frames", "-b", type=int,
    ...
    def _load_images(self):
        ...
        img_files = [f for f in Path(self.args.input).rglob("*") 
    ...
    def _process_frame(self, frame, frame_idx=0):
        ...
        if np.mean(gray) < 10 and np.var(gray) < 10:
            ...
            if blank_cnt % self.args.skip_blank_frames == 0:
                print(f"[WARN] Blank screen detected, skipping next {self.args.skip_blank_frames} frames.")
            return None
